    ...
    <nav className="fixed top-0 w-full z-50 px-6 py-4">
      <div className="max-w-7xl mx-auto flex justify-between items-center bg-white/5 backdrop-blur-lg border border-white/10 px-8 py-4 rounded-2xl shadow-2xl">
        ...
        <div className="hidden md:flex items-center gap-10">
          ...
          <a href="https://www.linkedin.com/in/sachin-singh-4998271a0/" target="_blank" rel="noreferrer" className="text-sm font-bold text-slate-300 hover:text-emerald-400 transition-all uppercase tracking-widest">LinkedIn</a>
